...
```{r}
knitr::include_graphics(here::here("themes","forty","static","img", "sailing.jpeg"), error = FALSE)
```
...
```{r}
knitr::include_graphics(here::here("themes","forty","static","img", "graduation.jpeg"), error = FALSE)
```
